...
class FlaskrTestCase(unittest.TestCase):
    ...
    def test_register(self):
        rv = self.app.post(root_uri + 'register', data=json.dumps({'email': 'gusan092@student.liu.se', 'password': 'password', 'first_name': 'Gustav', 'last_name': 'Andersson', 'city': 'Linkoping'}), content_type='application/json')
    ...
    def test_login(self):
        ...
        rv = self.app.post(root_uri + 'login', data=json.dumps({'email': 'gusan092@student.liu.se', 'password': 'wrongpassword'}), content_type='application/json')
